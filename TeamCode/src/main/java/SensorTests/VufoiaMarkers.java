...
@TeleOp(name = "Vuforia")
public class VufoiaMarkers extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        VuforiaTrackables trackables = this.vuforia.loadTrackablesFromAsset("abc");

        VuforiaTrackable track = trackables.get(0);
        track.setName("Stone");
